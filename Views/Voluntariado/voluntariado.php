                ...
                <div class="col-md-6">
                    <div class="video">
                        <h1>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                            Dolore mollitia qui optio iusto fugit sunt earum voluptates dolor,
                             delectus minima repellat amet repellendus suscipit velit reprehenderit
                              repudiandae maxime ab omnis.</h1>
                    </div>
                </div>
                <div class="col-md-6 bg-dark d-flex align-items-center" id="modalFormVoluntariado" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"  aria-hidden="true">
                   <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h1 class="text-white mb-4">Formulario para voluntarios</h1>
