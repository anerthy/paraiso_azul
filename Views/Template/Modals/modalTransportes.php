          ...
          <div class="tile-body">
            <form id="formTransporte" name="formTransporte">
              ...
              <div class="form-group">
                ...
                <input class="form-control valid validNumber" maxlength="8" id="txtTelefono" name="txtTelefono" rows="2" placeholder="Telefono del transporte" required="" onkeypress="return controlTag(event);">
              </div>
              <div class="form-group">
