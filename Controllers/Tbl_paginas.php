	...
	public function getTbl_paginas()
	{
		...
		for ($i = 0; $i < count($arrData); $i++) {
			...
			$arrData[$i]['options'] = '<div class="text-center">
				...
				<button class="btn btn-primary btn-sm btnEditTbl_pagina" onClick="fntEditTbl_pagina(' . $arrData[$i]['pag_id'] . ')" title="Editar"><i class="fas fa-pencil-alt"></i></button>
				<button class="btn btn-danger btn-sm btnDelTbl_pagina" onClick="fntDelTbl_pagina(' . $arrData[$i]['pag_id'] . ')" title="Eliminar"><i class="far fa-trash-alt"></i></button>
				<button class="btn btn-info btn-sm" onClick="fntViewInfo(' . $arrData[$i]['pag_id'] . ')" title="Ver comunidad"><i class="far fa-eye"></i></button>
				</div>';
		}
